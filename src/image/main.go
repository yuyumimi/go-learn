...
import (
	"fmt"
	"idea-test-project/src/image/prominentcolor"
	"image"
	_ "image/jpeg"
	_ "image/png"
	"io/ioutil"
...
https://github.com/EdlinOrg/prominentcolor.git
*/
...
func main() {
	// Prepare
	outputDirectory := "./src/image/prominentcolor/"
	dataDirectory := "./src/image/prominentcolor/"
	...
	for _, f := range files {
		...
		// Load the image
		img, err := loadImage(dataDirectory + filename)
		if err != nil {
